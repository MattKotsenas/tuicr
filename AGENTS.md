...
7. **Reload diff/session**: `:e` re-runs VCS diff loading and persists the resulting file hashes and invalidated review markers without saving unrelated dirty edits. Persisted comments are merged from the same locked session update.
